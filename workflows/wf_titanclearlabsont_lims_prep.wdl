...
workflow masphl_clearlabsont_lims_prep {
  meta {
    description: "Takes output form Theiagens Titan_ClearLabs and aggregates for LIMS integration"
  }
  input {
    String    samplename
    ...
    String    analysis_method = "ClearLabsONT"
